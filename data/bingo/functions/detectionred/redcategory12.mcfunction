...
execute if score Lockout GameSetup matches 0 if score beetrootsoup RedItems matches 1 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 1 if score beetrootsoup RedItems matches 1 if score beetrootsoup BlueItems matches 0 if score beetrootsoup GreenItems matches 0 if score beetrootsoup YellowItems matches 0 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 0 if score emerald RedItems matches 1 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 1 if score emerald RedItems matches 1 if score emerald BlueItems matches 0 if score emerald GreenItems matches 0 if score emerald YellowItems matches 0 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
