...
execute if score Lockout GameSetup matches 0 if score cauldron GreenItems matches 1 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 1 if score cauldron GreenItems matches 1 if score cauldron RedItems matches 0 if score cauldron BlueItems matches 0 if score cauldron YellowItems matches 0 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
